function [plyFile, plyRelativePath] = mMitsubaImportMexximpMesh(scene, mesh, varargin)
%% Convert a mexximp mesh to a PLY file that we can pass to Mitsuba.
%
% plyFile = mMitsubaImportMexximpMesh(scene, mesh) converts the given mexximp
...
%
% mMitsubaImportMexximpMesh( ... 'workingFolder', workingFolder) specify the
% folder where PLY file will be written.  The default is pwd().
%
% mMitsubaImportMexximpMesh( ... 'meshSubfolder', meshSubfolder) specify the
...
% workingFolder.
%
% mMitsubaImportMexximpMesh( ... 'rewriteMeshData', rewriteMeshData)
...
%
% [plyFile, plyRelativePath] = mMitsubaImportMexximpMesh(scene, mesh, varargin)
%
