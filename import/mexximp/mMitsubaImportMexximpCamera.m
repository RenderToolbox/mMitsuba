function mitsubaNode = mMitsubaImportMexximpCamera(scene, camera, varargin)
%% Convert a mexximp camera to mMitsuba sensor element.
%
% mitsubaNode = mMitsubaImportMexximpCamera(scene, camera) converts the given
...
%   mMitsubaImportMexximpCamera( ... 'cameraType', 'orthographic');
%
% Returns an mMitsuba sensor element with type camera and parameters
% filled in based on the mexximp camera.
%
% mitsubaNode = mMitsubaImportMexximpCamera(scene, camera, varargin)
%
