function mitsubaNodes = mMitsubaImportMexximpNode(scene, node, meshFiles, materialIds, varargin)
%% Convert a mexximp nodes to Mitsuba ply shape elements.
%
% mitsubaNodes = mMitsubaImportMexximpNode(scene, node, meshFiles) converts the
...
% material.
%
% mitsubaNodes = mMitsubaImportMexximpNode(scene, node, varargin)
%
