function mitsubaNode = mMitsubaImportMexximpLight(scene, light, varargin)
%% Convert a mexximp light to an mMitsuba emitter element.
%
% mitsubaNode = mMitsubaImportMexximpLight(scene, light) converts the given
...
%
% mitsubaNode = mMitsubaImportMexximpLight(scene, light, varargin)
%
